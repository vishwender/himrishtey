...
class HomeController extends Controller
{
    ...
    */
    ...
    public function view_my_profile()
    {
        ...
        $profile->profile_photo_url = filled($profile->photo)
            ? asset('photos/photo/' . basename($profile->photo))
    ...
    */
    ...
    public function unlock_contact(Request $request, $profileId)
    {
        ...
        $result = DB::transaction(function () use ($userId, $profileId, $usr) {
            ...
            $alreadyUnlocked = DB::table('viewed_contacts')
    ...
    {
        return DB::table('profile_viewed')
    ...
    public function uploadPhotos(Request $request)
    {
        ...
        foreach ($request->file('photos') as $photo) {
            ...
            $uploadedPhotos[] = [
                'id' => $galleryPhoto->id,
                'url' => asset('uploads/gallery/' . $imageName),
            ];
        }
    ...
    public function deleteGalleryPhoto(int $photo)
    {
        ...
        $photoPath = public_path('uploads/gallery/' . basename($galleryPhoto->photo));
